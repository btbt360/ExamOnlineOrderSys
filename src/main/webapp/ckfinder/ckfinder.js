	...
	(function() {
		...
		CKFinder.prototype = {
			...
			popup : function(g, h) {
				...
				var n = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><!DOCTYPE HTML><head><title>文件管理</title><meta http-equiv="X-UA-Compatible" content="edge" /><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="robots" content="noindex, nofollow" /><style type="text/css">body, html, iframe, #ckfinder { margin: 0; padding: 0; border: 0; width: 100%; height: 100%; overflow: hidden; }</style></head><body></body></html>', o = new a.dom.document(
						m.document);
				o.$.open();
							...
							dQ : function(p) {
								...
								var t = p.oW('themeSpace', {
									...
									html : ''
										...
										|| 'kama', A = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><!DOCTYPE html lang="'
										+ p.lang.LangCode
										+ '" dir="'
										+ p.lang.dir
										+ '">'
										+ '<head>'
										+ '<meta http-equiv="X-UA-Compatible" content="edge" /><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="robots" content="noindex, nofollow" />'
										+ t.html
										+ '</head>'
										+ '<body>'
